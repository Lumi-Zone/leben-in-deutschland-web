...
## Schritt 1: Prüfstelle finden
*   Besuchen Sie die Website Ihrer lokalen VHS oder suchen Sie auf der BAMF-Website nach "Prüfstellen in meiner Nähe".
*   Tipp: Schauen Sie auch in Nachbarstädten. Oft sind die Termine in großen Städten wie Berlin oder München monatelang ausgebucht, während es im Umland noch Plätze gibt.

## Schritt 2: Persönliche Anmeldung
In fast allen Fällen müssen Sie sich **persönlich** vor Ort anmelden. Eine Online-Anmeldung ist oft nicht möglich, da Ihre Identität geprüft werden muss.
*   **Was Sie mitbringen müssen**:
    *   Ihren Pass oder Ausweis (mit Foto).
    *   25,00 Euro in Bar oder EC-Karte.

## Schritt 3: Die Wartezeit
Nach der Anmeldung müssen Sie warten. Die Anmeldefrist endet meist **4 Wochen vor dem Prüfungstermin**. Melden Sie sich also mindestens 2 Monate im Voraus an, um sicher einen Platz zu bekommen.

## Schritt 4: Der Prüfungstag
*   Kommen Sie pünktlich (mindestens 15 Minuten vorher).
*   Bringen Sie **unbedingt** Ihren Ausweis und einen Kugelschreiber (blau oder schwarz) mit.
